...
#Como el modulo de alto nivel, (contar_piezas_reparacion) depende de las clases concretas (Celular, Tablet, Smartwatch) se viola el Principio de Inversion de Dependencia (DIP)
...
#Ahora el módulo de alto nivel (contar_piezas_reparacion) → depende de una abstracción (Dispositivo), no de clases concretas.
